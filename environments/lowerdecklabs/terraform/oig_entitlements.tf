...
resource "okta_entitlement_bundle" "purchasing" {
  name = "Purchasing"
  target_resource_orn = "orn:okta:governance:00omx5xxhePEbjFNp1d7:entitlement-bundles:enb13o2ewjNG3y8LM1d7"
  status = "ACTIVE"
  ...
  # Bundle Type: MANUAL
  # ORN: orn:okta:governance:00omx5xxhePEbjFNp1d7:entitlement-bundles:enb13o2ewjNG3y8LM1d7
}
